...
const state = {
  ...
  knowledge: [
    ...
    { id: 'knowledge-admin-regulation', title: 'Регламент администратора', content: 'Правила открытия смены и сдачи отчётов.', role: 'ADMIN', category: 'REGULATION', businessModel: 'ALL', hashtags: '#регламент', isActual: true, searchable: true, createdAt: now },
